...
$(document).ready(function () {
    ...
    $('#ParameterInput').on('submit', function (e) {
        ...
        // document.write("tfp=",round(tfp,5),"<br>");
        // document.write("alpha=",round(alpha,5),"<br>");
        // document.write("delta=",round(delta,5),"<br>");
        // document.write("beta=",round(beta,5),"<br>");
        // document.write("sigma=",round(sigma,5),"<br>");
        // document.write("eta=",round(eta,5),"<br>");
        // document.write("phi=",round(phi,5),"<br>");
        // document.write("rhoA=",round(rhoA,5),"<br>");
        // document.write("sigA=",round(sigA,5),"<br>");
        // document.write("periods=",round(periods,5),"<br>");
        // document.write("stochastic=",stochSim.checked.toString(),"<br>");
        // document.write("<br>");
        ...
        // document.write("A=",round(tfp,5),"<br>");
